export const useFormationStyleViewModel = () => {
    const formationPositionStyles: Record<string, Record<string, { top: string; left: string }[]>> = {
        ...
        '3-2-3-2': {
            ...
            midfielders: [
                {top: '40%', left: '40%'},   // Defensive-midfield
                {top: '40%', left: '60%'},   // Defensive-midfield
                {top: '40%', left: '20%'},   // Left-midfield
        ...
        '4-3-3': {
            ...
            midfielders: [
                {top: '35%', left: '40%'},   // Left Center-midfield
                {top: '35%', left: '50%'},   // Center-midfield
                {top: '35%', left: '60%'},   // Right Center-midfield
            ],
            forwards: [
